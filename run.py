...
def get_sales_data():
    ...
    while True:
        ...
        print("Data should be six numbers, sparated by")
...
def update_sales_worsheet(data):
    ...
    print("Sales worksheet updated successfullt.\n")
...
def update_surplus_worsheet(data):
    ...
    print("Surplus worksheet updated successfullt.\n")

def calculate_surplus_data(sales_row):
    """
    Compare sales with stock and calculate the surplus for each item type.

    The surplus is defined as the sales figur subtracted from the stock:
